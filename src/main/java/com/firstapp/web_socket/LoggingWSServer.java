package com.firstapp.web_socket;
...
//    private String applicationName;
    ...
    //    Logger log=LogFactory.getLog(MySpringBootApp.class);
    Logger log = LoggerFactory.getLogger(MySpringBootApp.class);
...
//                    String filePath = System.getProperty("user.home") + "/log/" + new SimpleDateFormat("yyyyMMdd").format(new Date()) + "/" + applicationName + ".log";
                    String filePath="logback.2020-01-09.log";
